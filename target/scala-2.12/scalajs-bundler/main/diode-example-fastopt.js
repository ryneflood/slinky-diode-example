...
var $i_resources$002flogo$002esvg = require("resources/logo.svg");
...
function $is_Ldiode_Effect(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Ldiode_Effect)))
}
function $as_Ldiode_Effect(obj) {
  return (($is_Ldiode_Effect(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "diode.Effect"))
}
function $isArrayOf_Ldiode_Effect(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Ldiode_Effect)))
}
function $asArrayOf_Ldiode_Effect(obj, depth) {
  return (($isArrayOf_Ldiode_Effect(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Ldiode.Effect;", depth))
}
...
$c_Ldiode_ActionHandler.prototype.liftedHandler$lzycompute__p1__F1 = (function() {
  if ((!this.bitmap$0$1)) {
    var this$1 = new $c_Lexample_diode_store_CounterStore$CounterHandler$$anonfun$handle$1().init___Lexample_diode_store_CounterStore$CounterHandler(this);
...
/** @constructor */
function $c_Ldiode_ActionResult$() {
  $c_O.call(this)
}
$c_Ldiode_ActionResult$.prototype = new $h_O();
$c_Ldiode_ActionResult$.prototype.constructor = $c_Ldiode_ActionResult$;
/** @constructor */
function $h_Ldiode_ActionResult$() {
  /*<skip>*/
}
$h_Ldiode_ActionResult$.prototype = $c_Ldiode_ActionResult$.prototype;
$c_Ldiode_ActionResult$.prototype.init___ = (function() {
  return this
});
$c_Ldiode_ActionResult$.prototype.apply__s_Option__s_Option__Ldiode_ActionResult = (function(model, effect) {
  if ($is_s_Some(model)) {
    var x4 = $as_s_Some(model);
    var m = x4.value$2;
    if ($is_s_Some(effect)) {
      var x5 = $as_s_Some(effect);
      var e = $as_Ldiode_Effect(x5.value$2);
      return new $c_Ldiode_ActionResult$ModelUpdateEffect().init___O__Ldiode_Effect(m, e)
    }
  };
  if ($is_s_Some(model)) {
    var x8 = $as_s_Some(model);
    var m$2 = x8.value$2;
    var x = $m_s_None$();
    if ((x === effect)) {
      return new $c_Ldiode_ActionResult$ModelUpdate().init___O(m$2)
    }
  };
  var x$3 = $m_s_None$();
  if (((x$3 === model) && $is_s_Some(effect))) {
    var x11 = $as_s_Some(effect);
    var e$2 = $as_Ldiode_Effect(x11.value$2);
    return new $c_Ldiode_ActionResult$EffectOnly().init___Ldiode_Effect(e$2)
  };
  return $m_Ldiode_ActionResult$NoChange$()
});
var $d_Ldiode_ActionResult$ = new $TypeData().initClass({
  Ldiode_ActionResult$: 0
}, false, "diode.ActionResult$", {
  Ldiode_ActionResult$: 1,
  O: 1
});
$c_Ldiode_ActionResult$.prototype.$classData = $d_Ldiode_ActionResult$;
var $n_Ldiode_ActionResult$ = (void 0);
function $m_Ldiode_ActionResult$() {
  if ((!$n_Ldiode_ActionResult$)) {
    $n_Ldiode_ActionResult$ = new $c_Ldiode_ActionResult$().init___()
  };
  return $n_Ldiode_ActionResult$
}
...
function $f_Ldiode_Circuit__update__pLdiode_Circuit__O__V($thiz, newModel) {
  if ((newModel !== $thiz.model$1)) {
    $thiz.model$1 = $as_Lexample_diode_store_AppModel(newModel)
  }
}
...
function $f_Ldiode_Circuit__foldHandlers__sc_Seq__F2($thiz, handlers) {
  return new $c_sjsr_AnonFunction2().init___sjs_js_Function2((function($this, handlers$1) {
    return (function(initialModel$2, action$2) {
      return $as_s_Option($as_T2(handlers$1.foldLeft__O__F2__O(new $c_T2().init___O__O(initialModel$2, $m_s_None$()), new $c_sjsr_AnonFunction2().init___sjs_js_Function2((function($this$1, action) {
        return (function(x0$1$2, x1$1$2) {
          var x0$1 = $as_T2(x0$1$2);
          var x1$1 = $as_F2(x1$1$2);
          var x1 = new $c_T2().init___O__O(x0$1, x1$1);
          var p2 = $as_T2(x1.$$und1$f);
          var handler = $as_F2(x1.$$und2$f);
          if ((p2 !== null)) {
            var currentModel = p2.$$und1$f;
            var currentResult = $as_s_Option(p2.$$und2$f);
            var x1$2 = $as_s_Option(handler.apply__O__O__O(currentModel, action));
            var x = $m_s_None$();
            if ((x === x1$2)) {
              return new $c_T2().init___O__O(currentModel, currentResult)
            } else if ($is_s_Some(x1$2)) {
              var x2 = $as_s_Some(x1$2);
              var result = $as_Ldiode_ActionResult(x2.value$2);
              if ($is_s_Some(currentResult)) {
                var x2$2 = $as_s_Some(currentResult);
                var cr = $as_Ldiode_ActionResult(x2$2.value$2);
                var x1$4 = new $c_T2().init___O__O(cr.effectOpt__s_Option(), result.effectOpt__s_Option());
                matchEnd19: {
                  var newEffect;
                  var p2$2 = $as_s_Option(x1$4.$$und1$f);
                  var p3 = $as_s_Option(x1$4.$$und2$f);
                  if ($is_s_Some(p2$2)) {
                    var x4 = $as_s_Some(p2$2);
                    var e1 = $as_Ldiode_Effect(x4.value$2);
                    if ($is_s_Some(p3)) {
                      var x5 = $as_s_Some(p3);
                      var e2 = $as_Ldiode_Effect(x5.value$2);
                      var newEffect = new $c_s_Some().init___O(e1.$$plus__Ldiode_Effect__Ldiode_EffectSet(e2));
                      break matchEnd19
                    }
                  };
                  var p6 = $as_s_Option(x1$4.$$und1$f);
                  var p7 = $as_s_Option(x1$4.$$und2$f);
                  if ($is_s_Some(p6)) {
                    var x8 = $as_s_Some(p6);
                    var e1$2 = $as_Ldiode_Effect(x8.value$2);
                    var x$3 = $m_s_None$();
                    if ((x$3 === p7)) {
                      var newEffect = new $c_s_Some().init___O(e1$2);
                      break matchEnd19
                    }
                  };
                  var p9 = $as_s_Option(x1$4.$$und1$f);
                  var p10 = $as_s_Option(x1$4.$$und2$f);
                  var x$5 = $m_s_None$();
                  if (((x$5 === p9) && $is_s_Some(p10))) {
                    var x11 = $as_s_Some(p10);
                    var e2$2 = $as_Ldiode_Effect(x11.value$2);
                    var newEffect = new $c_s_Some().init___O(e2$2);
                    break matchEnd19
                  };
                  var p12 = $as_s_Option(x1$4.$$und1$f);
                  var p13 = $as_s_Option(x1$4.$$und2$f);
                  var x$7 = $m_s_None$();
                  if ((x$7 === p12)) {
                    var x$9 = $m_s_None$();
                    var jsx$1 = (x$9 === p13)
                  ...
                  if (jsx$1) {
                    var newEffect = $m_s_None$();
                    break matchEnd19
                  };
                  throw new $c_s_MatchError().init___O(x1$4)
                };
                var this$2 = result.newModelOpt__s_Option();
                var newModel = (this$2.isEmpty__Z() ? cr.newModelOpt__s_Option() : this$2);
                var _1 = (newModel.isEmpty__Z() ? currentModel : newModel.get__O());
                var _2 = $m_Ldiode_ActionResult$().apply__s_Option__s_Option__Ldiode_ActionResult(newModel, newEffect);
                var x1$5_$_$$und1$f = _1;
                var x1$5_$_$$und2$f = _2
              } else {
                var x$11 = $m_s_None$();
                if ((!(x$11 === currentResult))) {
                  throw new $c_s_MatchError().init___O(currentResult)
                };
                var this$3 = result.newModelOpt__s_Option();
                var _1$1 = (this$3.isEmpty__Z() ? currentModel : this$3.get__O());
                var x1$5_$_$$und1$f = _1$1;
                var x1$5_$_$$und2$f = result
              };
              var nextModel = x1$5_$_$$und1$f;
              var nextResult = $as_Ldiode_ActionResult(x1$5_$_$$und2$f);
              return new $c_T2().init___O__O(nextModel, new $c_s_Some().init___O(nextResult))
            } else {
...
function $f_Ldiode_Circuit__handleEffectProcessingError__O__jl_Throwable__V($thiz, action, error) {
  var msg = ((("Error in processing effects for action " + action) + ": ") + error);
...
function $f_Ldiode_Circuit__$$init$__V($thiz) {
  var x$1 = new $c_Lexample_diode_store_AppModel().init___Lexample_diode_store_CounterStore$CounterState(new $c_Lexample_diode_store_CounterStore$CounterState().init___I(0));
  $thiz.model$1 = x$1;
...
function $f_Ldiode_Circuit__baseHandler__pLdiode_Circuit__O__Ldiode_ActionResult$NoChange$($thiz, action) {
  if ($is_Ldiode_ActionBatch(action)) {
    ...
    if ((x === action)) {
      ...
      var msg = (("Action " + action) + " was not handled by any action handler");
      $f_Ldiode_Circuit__handleError__T__V($thiz, msg);
      return $m_Ldiode_ActionResult$NoChange$()
    }
  }
...
function $f_Ldiode_Circuit__handleError__T__V($thiz, msg) {
  throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(new $c_jl_Exception().init___T(("handleError called with: " + msg)))
}
...
/** @constructor */
function $c_Lexample_diode_Counter$() {
  $c_O.call(this);
  this.component$1 = null
}
$c_Lexample_diode_Counter$.prototype = new $h_O();
$c_Lexample_diode_Counter$.prototype.constructor = $c_Lexample_diode_Counter$;
/** @constructor */
function $h_Lexample_diode_Counter$() {
  /*<skip>*/
}
$h_Lexample_diode_Counter$.prototype = $c_Lexample_diode_Counter$.prototype;
$c_Lexample_diode_Counter$.prototype.init___ = (function() {
  $n_Lexample_diode_Counter$ = this;
  var fn = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($this) {
    return (function(x$1$2) {
      $asUnit(x$1$2);
      var jsx$2 = $m_Lexample_diode_hooks_Diode$();
      var jsx$1 = $m_Lexample_diode_App$().diodeContext$3;
      var this$1 = $m_Lexample_diode_store_AppCircuit$();
      var get = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($this$1) {
        return (function(x$1$2$2) {
          var x$1$2$1 = $as_Lexample_diode_store_AppModel(x$1$2$2);
          return x$1$2$1.counter$1
        })
      })($this));
      var set = new $c_sjsr_AnonFunction2().init___sjs_js_Function2((function(this$2) {
        return (function(m$2, t$2) {
          $as_Lexample_diode_store_AppModel(m$2);
          var t = $as_Lexample_diode_store_CounterStore$CounterState(t$2);
          return new $c_Lexample_diode_store_AppModel().init___Lexample_diode_store_CounterStore$CounterState(t)
        })
      })($this));
      var feq = $m_Ldiode_FastEq$().AnyRefEq__Ldiode_FastEqLowPri$AnyRefEq$();
      var this$3 = this$1.diode$Circuit$$modelRW$1;
      var x1 = jsx$2.useDiode__Lslinky_core_facade_ReactContext__Ldiode_ModelR__T2(jsx$1, new $c_Ldiode_ZoomModelRW().init___Ldiode_ModelR__F1__F2__Ldiode_FastEq(this$3, get, set, feq));
      if ((x1 === null)) {
        throw new $c_s_MatchError().init___O(x1)
      };
      var counterState = $as_Lexample_diode_store_CounterStore$CounterState(x1.$$und1$f);
      var dispatch = $as_Ldiode_Dispatcher(x1.$$und2$f);
      var s = ("Count is " + counterState.count$1);
      var properties = {};
      var x0$2 = $i_react.createElement("p", properties, s);
      var this$65 = $m_Lslinky_core_facade_Fragment$();
      var v = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(this$3$1, dispatch$2) {
        return (function(x$4$2) {
          var action = $m_Lexample_diode_store_CounterStore$Increment$();
          var evidence$2 = $m_Ldiode_Action$aType$();
          $f_Ldiode_Circuit__dispatch__O__Ldiode_ActionType__V(dispatch$2, action, evidence$2)
        })
      })($this, dispatch));
      var pair = new $c_Lslinky_core_AttrPair().init___T__sjs_js_Any("onClick", (function(f) {
      ...
      while ((i < len)) {
        ...
        dictionary[m$1.name$1] = m$1.value$1;
        i = ((1 + i) | 0)
      };
      var this$24 = new $c_Lslinky_core_WithAttrs().init___T__sjs_js_Dictionary("button", dictionary);
      var a = this$24.slinky$core$WithAttrs$$name$f;
      var properties$1 = this$24.slinky$core$WithAttrs$$attrs$f;
      var x0 = $i_react.createElement(a, properties$1, "Increment");
      var v$1 = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(this$4$1, dispatch$2$1) {
        return (function(x$5$2) {
          var action$1 = $m_Lexample_diode_store_CounterStore$Decrement$();
          var evidence$2$1 = $m_Ldiode_Action$aType$();
          $f_Ldiode_Circuit__dispatch__O__Ldiode_ActionType__V(dispatch$2$1, action$1, evidence$2$1)
        })
      })($this, dispatch));
      var pair$1 = new $c_Lslinky_core_AttrPair().init___T__sjs_js_Any("onClick", (function(f$1) {
      ...
      var array$1 = [];
      var dictionary$1 = {};
      dictionary$1[pair$1.name$1] = pair$1.value$1;
      var i$1 = 0;
      var len$1 = $uI(array$1.length);
      while ((i$1 < len$1)) {
        var index$1 = i$1;
        var arg1$3 = array$1[index$1];
        var m$3 = $as_Lslinky_core_AttrPair(arg1$3);
        dictionary$1[m$3.name$1] = m$3.value$1;
        i$1 = ((1 + i$1) | 0)
      };
      var this$40 = new $c_Lslinky_core_WithAttrs().init___T__sjs_js_Dictionary("button", dictionary$1);
      var a$1 = this$40.slinky$core$WithAttrs$$name$f;
      var properties$2 = this$40.slinky$core$WithAttrs$$attrs$f;
      var x1$1 = $i_react.createElement(a$1, properties$2, "Decrement");
      var v$2 = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(this$5$1, dispatch$2$2) {
        return (function(x$6$2) {
          var action$2 = $m_Lexample_diode_store_CounterStore$Reset$();
          var evidence$2$2 = $m_Ldiode_Action$aType$();
          $f_Ldiode_Circuit__dispatch__O__Ldiode_ActionType__V(dispatch$2$2, action$2, evidence$2$2)
        })
      })($this, dispatch));
      var pair$2 = new $c_Lslinky_core_AttrPair().init___T__sjs_js_Any("onClick", (function(f$2) {
      ...
      var array$2 = [];
      var dictionary$2 = {};
      dictionary$2[pair$2.name$1] = pair$2.value$1;
      var i$2 = 0;
      var len$2 = $uI(array$2.length);
      while ((i$2 < len$2)) {
        var index$2 = i$2;
        var arg1$5 = array$2[index$2];
        var m$4 = $as_Lslinky_core_AttrPair(arg1$5);
        dictionary$2[m$4.name$1] = m$4.value$1;
        i$2 = ((1 + i$2) | 0)
      };
      var this$56 = new $c_Lslinky_core_WithAttrs().init___T__sjs_js_Dictionary("button", dictionary$2);
      var a$2 = this$56.slinky$core$WithAttrs$$name$f;
      var properties$3 = this$56.slinky$core$WithAttrs$$attrs$f;
      var x2 = $i_react.createElement(a$2, properties$3, "Reset");
      var elementName = this$65.component$4;
      var properties$4 = {};
      var x0$1 = $i_react.createElement(elementName, properties$4, x0, x1$1, x2);
      var properties$5 = {};
      var x1$2 = $i_react.createElement("div", properties$5, x0$1);
      var properties$6 = {};
      return $i_react.createElement("div", properties$6, x0$2, x1$2)
    })
  })(this));
  this.component$1 = new $c_Lexample_diode_FunctionalComponent().init___F1(fn);
  return this
});
var $d_Lexample_diode_Counter$ = new $TypeData().initClass({
  Lexample_diode_Counter$: 0
}, false, "example.diode.Counter$", {
  Lexample_diode_Counter$: 1,
  O: 1
});
$c_Lexample_diode_Counter$.prototype.$classData = $d_Lexample_diode_Counter$;
var $n_Lexample_diode_Counter$ = (void 0);
function $m_Lexample_diode_Counter$() {
  if ((!$n_Lexample_diode_Counter$)) {
    $n_Lexample_diode_Counter$ = new $c_Lexample_diode_Counter$().init___()
  };
  return $n_Lexample_diode_Counter$
}
/** @constructor */
function $c_Lexample_diode_FunctionalComponent() {
  $c_O.call(this);
  this.fn$1 = null;
  this.component$1 = null
}
$c_Lexample_diode_FunctionalComponent.prototype = new $h_O();
$c_Lexample_diode_FunctionalComponent.prototype.constructor = $c_Lexample_diode_FunctionalComponent;
/** @constructor */
function $h_Lexample_diode_FunctionalComponent() {
  /*<skip>*/
}
$h_Lexample_diode_FunctionalComponent.prototype = $c_Lexample_diode_FunctionalComponent.prototype;
$c_Lexample_diode_FunctionalComponent.prototype.apply__O__Lslinky_core_facade_ReactElement = (function(props) {
  var a = this.component$1;
  var properties = {
    "__": props
  };
  return $i_react.createElement(a, properties)
});
$c_Lexample_diode_FunctionalComponent.prototype.example$diode$FunctionalComponent$$$anonfun$component$1__sjs_js_Object__Lslinky_core_facade_ReactElement = (function(obj) {
  return this.fn$1.apply__O__O(obj.__)
});
$c_Lexample_diode_FunctionalComponent.prototype.init___F1 = (function(fn) {
  this.fn$1 = fn;
  this.component$1 = (function(arg$outer) {
    return (function(arg1$2) {
      return arg$outer.example$diode$FunctionalComponent$$$anonfun$component$1__sjs_js_Object__Lslinky_core_facade_ReactElement(arg1$2)
    })
  })(this);
  return this
});
var $d_Lexample_diode_FunctionalComponent = new $TypeData().initClass({
  Lexample_diode_FunctionalComponent: 0
}, false, "example.diode.FunctionalComponent", {
  Lexample_diode_FunctionalComponent: 1,
  O: 1
});
$c_Lexample_diode_FunctionalComponent.prototype.$classData = $d_Lexample_diode_FunctionalComponent;
/** @constructor */
function $c_Lexample_diode_Main$() {
  $c_O.call(this);
  this.css$1 = null
}
$c_Lexample_diode_Main$.prototype = new $h_O();
$c_Lexample_diode_Main$.prototype.constructor = $c_Lexample_diode_Main$;
/** @constructor */
function $h_Lexample_diode_Main$() {
  /*<skip>*/
}
$h_Lexample_diode_Main$.prototype = $c_Lexample_diode_Main$.prototype;
$c_Lexample_diode_Main$.prototype.init___ = (function() {
  $n_Lexample_diode_Main$ = this;
  this.css$1 = $moduleDefault($i_resources$002findex$002ecss);
  return this
});
$c_Lexample_diode_Main$.prototype.main__V = (function() {
  ...
  var this$5 = $m_Lexample_diode_App$();
  var constructor = $a_Lexample_diode_App();
...
var $d_Lexample_diode_Main$ = new $TypeData().initClass({
  Lexample_diode_Main$: 0
}, false, "example.diode.Main$", {
  Lexample_diode_Main$: 1,
  O: 1
});
$c_Lexample_diode_Main$.prototype.$classData = $d_Lexample_diode_Main$;
var $n_Lexample_diode_Main$ = (void 0);
function $m_Lexample_diode_Main$() {
  if ((!$n_Lexample_diode_Main$)) {
    $n_Lexample_diode_Main$ = new $c_Lexample_diode_Main$().init___()
  };
  return $n_Lexample_diode_Main$
}
/** @constructor */
function $c_Lexample_diode_hooks_Diode$() {
  $c_O.call(this)
}
$c_Lexample_diode_hooks_Diode$.prototype = new $h_O();
$c_Lexample_diode_hooks_Diode$.prototype.constructor = $c_Lexample_diode_hooks_Diode$;
/** @constructor */
function $h_Lexample_diode_hooks_Diode$() {
  /*<skip>*/
}
$h_Lexample_diode_hooks_Diode$.prototype = $c_Lexample_diode_hooks_Diode$.prototype;
$c_Lexample_diode_hooks_Diode$.prototype.init___ = (function() {
  return this
});
$c_Lexample_diode_hooks_Diode$.prototype.useDiode__Lslinky_core_facade_ReactContext__Ldiode_ModelR__T2 = (function(context, selector) {
  var circuit = $as_Ldiode_Circuit($m_Lexample_diode_hooks_Hooks$().useContext__Lslinky_core_facade_ReactContext__O(context));
  var x1 = $m_Lexample_diode_hooks_Hooks$().useState__O__T2(selector.value__O());
  if ((x1 === null)) {
    throw new $c_s_MatchError().init___O(x1)
  };
  var state = x1.$$und1$f;
  var setState = $as_F1(x1.$$und2$f);
  $m_Lexample_diode_hooks_Hooks$().useEffect__F0__sc_Seq__V(new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function($this, circuit$1, selector$1, setState$2) {
    return (function() {
      var listener = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($this$1, setState$2$1) {
        return (function(state$2) {
          var state$1 = $as_Ldiode_ModelRO(state$2);
          setState$2$1.apply__O__O(state$1.value__O())
        })
      })($this, setState$2));
      var subscription = $f_Ldiode_Circuit__subscribe__Ldiode_ModelR__F1__F0(circuit$1, selector$1, listener);
      return (function(subscription$2) {
        return (function() {
          subscription$2.apply__O()
        })
      })(subscription)
    })
  })(this, circuit, selector, setState)), $as_sc_Seq($m_sc_Seq$().apply__sc_Seq__sc_GenTraversable($m_sci_Nil$())));
  return new $c_T2().init___O__O(state, circuit)
});
var $d_Lexample_diode_hooks_Diode$ = new $TypeData().initClass({
  Lexample_diode_hooks_Diode$: 0
}, false, "example.diode.hooks.Diode$", {
  Lexample_diode_hooks_Diode$: 1,
  O: 1
});
$c_Lexample_diode_hooks_Diode$.prototype.$classData = $d_Lexample_diode_hooks_Diode$;
var $n_Lexample_diode_hooks_Diode$ = (void 0);
function $m_Lexample_diode_hooks_Diode$() {
  if ((!$n_Lexample_diode_hooks_Diode$)) {
    $n_Lexample_diode_hooks_Diode$ = new $c_Lexample_diode_hooks_Diode$().init___()
  };
  return $n_Lexample_diode_hooks_Diode$
}
/** @constructor */
function $c_Lexample_diode_hooks_Hooks$() {
  $c_O.call(this)
}
$c_Lexample_diode_hooks_Hooks$.prototype = new $h_O();
$c_Lexample_diode_hooks_Hooks$.prototype.constructor = $c_Lexample_diode_hooks_Hooks$;
/** @constructor */
function $h_Lexample_diode_hooks_Hooks$() {
  /*<skip>*/
}
$h_Lexample_diode_hooks_Hooks$.prototype = $c_Lexample_diode_hooks_Hooks$.prototype;
$c_Lexample_diode_hooks_Hooks$.prototype.init___ = (function() {
  return this
});
$c_Lexample_diode_hooks_Hooks$.prototype.useContext__Lslinky_core_facade_ReactContext__O = (function(context) {
  return $i_react.useContext(context)
});
$c_Lexample_diode_hooks_Hooks$.prototype.useState__O__T2 = (function($default) {
  var call = $i_react.useState($default);
  return new $c_T2().init___O__O(call[0], $m_sjs_js_Any$().toFunction1__sjs_js_Function1__F1(call[1]))
});
$c_Lexample_diode_hooks_Hooks$.prototype.useEffect__F0__sc_Seq__V = (function(f, depends) {
  $i_react.useEffect((function(f$1) {
    return (function() {
      return f$1.apply__O()
    })
  })(f), $m_sjs_js_JSConverters$JSRichGenTraversableOnce$().toJSArray$extension__sc_GenTraversableOnce__sjs_js_Array(depends))
});
var $d_Lexample_diode_hooks_Hooks$ = new $TypeData().initClass({
  Lexample_diode_hooks_Hooks$: 0
}, false, "example.diode.hooks.Hooks$", {
  Lexample_diode_hooks_Hooks$: 1,
  O: 1
});
$c_Lexample_diode_hooks_Hooks$.prototype.$classData = $d_Lexample_diode_hooks_Hooks$;
var $n_Lexample_diode_hooks_Hooks$ = (void 0);
function $m_Lexample_diode_hooks_Hooks$() {
  if ((!$n_Lexample_diode_hooks_Hooks$)) {
    $n_Lexample_diode_hooks_Hooks$ = new $c_Lexample_diode_hooks_Hooks$().init___()
  };
  return $n_Lexample_diode_hooks_Hooks$
}
/** @constructor */
...
/** @constructor */
function $c_Lslinky_core_BuildingComponent() {
  $c_O.call(this);
  this.c$1 = null;
  this.props$1 = null;
  this.key$1 = null;
...
$c_Lslinky_core_BuildingComponent.prototype = new $h_O();
$c_Lslinky_core_BuildingComponent.prototype.constructor = $c_Lslinky_core_BuildingComponent;
/** @constructor */
function $h_Lslinky_core_BuildingComponent() {
  /*<skip>*/
}
$h_Lslinky_core_BuildingComponent.prototype = $c_Lslinky_core_BuildingComponent.prototype;
$c_Lslinky_core_BuildingComponent.prototype.init___sjs_js_$bar__sjs_js_Object__T__sjs_js_Object__sc_Seq = (function(c, props, key, ref, mods) {
  this.c$1 = c;
  this.props$1 = props;
  this.key$1 = key;
  this.ref$1 = ref;
...
var $d_Lslinky_core_BuildingComponent = new $TypeData().initClass({
  Lslinky_core_BuildingComponent: 0
}, false, "slinky.core.BuildingComponent", {
  Lslinky_core_BuildingComponent: 1,
  O: 1
});
$c_Lslinky_core_BuildingComponent.prototype.$classData = $d_Lslinky_core_BuildingComponent;
/** @constructor */
...
/** @constructor */
function $c_Lslinky_core_ExternalComponentNoPropsWithAttributesWithRefType() {
  $c_O.call(this)
}
$c_Lslinky_core_ExternalComponentNoPropsWithAttributesWithRefType.prototype = new $h_O();
$c_Lslinky_core_ExternalComponentNoPropsWithAttributesWithRefType.prototype.constructor = $c_Lslinky_core_ExternalComponentNoPropsWithAttributesWithRefType;
/** @constructor */
function $h_Lslinky_core_ExternalComponentNoPropsWithAttributesWithRefType() {
  /*<skip>*/
}
$h_Lslinky_core_ExternalComponentNoPropsWithAttributesWithRefType.prototype = $c_Lslinky_core_ExternalComponentNoPropsWithAttributesWithRefType.prototype;
/** @constructor */
...
$c_Lslinky_core_ExternalComponentWithAttributesWithRefType.prototype.apply__O__Lslinky_core_BuildingComponent = (function(p) {
  var jsx$2 = this.component$4;
  var jsx$1 = this.writer$1.write__O__sjs_js_Object(p);
  $m_sc_Seq$();
  $m_sci_Seq$();
  var this$3 = new $c_scm_ListBuffer().init___();
  return new $c_Lslinky_core_BuildingComponent().init___sjs_js_$bar__sjs_js_Object__T__sjs_js_Object__sc_Seq(jsx$2, jsx$1, null, null, this$3.toList__sci_List())
});
/** @constructor */
...
/** @constructor */
function $c_Lslinky_core_facade_ContextProvider() {
  $c_O.call(this);
  this.External$module$1 = null;
  this.slinky$core$facade$ContextProvider$$orig$f = null
}
$c_Lslinky_core_facade_ContextProvider.prototype = new $h_O();
$c_Lslinky_core_facade_ContextProvider.prototype.constructor = $c_Lslinky_core_facade_ContextProvider;
/** @constructor */
function $h_Lslinky_core_facade_ContextProvider() {
  /*<skip>*/
}
$h_Lslinky_core_facade_ContextProvider.prototype = $c_Lslinky_core_facade_ContextProvider.prototype;
$c_Lslinky_core_facade_ContextProvider.prototype.init___Lslinky_core_facade_ReactContext = (function(orig) {
  this.slinky$core$facade$ContextProvider$$orig$f = orig;
  return this
});
$c_Lslinky_core_facade_ContextProvider.prototype.External__p1__Lslinky_core_facade_ContextProvider$External$ = (function() {
  if ((this.External$module$1 === null)) {
    this.External$lzycompute$1__p1__V()
  };
  return this.External$module$1
});
$c_Lslinky_core_facade_ContextProvider.prototype.External$lzycompute$1__p1__V = (function() {
  if ((this.External$module$1 === null)) {
    this.External$module$1 = new $c_Lslinky_core_facade_ContextProvider$External$().init___Lslinky_core_facade_ContextProvider(this)
  }
});
$c_Lslinky_core_facade_ContextProvider.prototype.apply__O__Lslinky_core_BuildingComponent = (function(value) {
  return this.External__p1__Lslinky_core_facade_ContextProvider$External$().apply__O__Lslinky_core_BuildingComponent(new $c_Lslinky_core_facade_ContextProviderProps().init___O(value))
});
var $d_Lslinky_core_facade_ContextProvider = new $TypeData().initClass({
  Lslinky_core_facade_ContextProvider: 0
}, false, "slinky.core.facade.ContextProvider", {
  Lslinky_core_facade_ContextProvider: 1,
  O: 1
});
$c_Lslinky_core_facade_ContextProvider.prototype.$classData = $d_Lslinky_core_facade_ContextProvider;
/** @constructor */
function $c_Lslinky_core_facade_React$() {
  $c_O.call(this)
}
$c_Lslinky_core_facade_React$.prototype = new $h_O();
$c_Lslinky_core_facade_React$.prototype.constructor = $c_Lslinky_core_facade_React$;
/** @constructor */
function $h_Lslinky_core_facade_React$() {
  /*<skip>*/
}
$h_Lslinky_core_facade_React$.prototype = $c_Lslinky_core_facade_React$.prototype;
$c_Lslinky_core_facade_React$.prototype.init___ = (function() {
  return this
});
$c_Lslinky_core_facade_React$.prototype.createContext__O__Lslinky_core_facade_ReactContext = (function(defaultValue) {
  return $i_react.createContext(defaultValue)
});
$c_Lslinky_core_facade_React$.prototype.createElement__sjs_js_$bar__sjs_js_Dictionary__sc_Seq__Lslinky_core_facade_ReactElement = (function(elementName, properties, contents) {
  var jsx$1 = $i_react;
  var jsx$4 = jsx$1.createElement;
  var this$2 = $m_sjsr_Compat$();
  if ($is_sjs_js_ArrayOps(contents)) {
    var x2 = $as_sjs_js_ArrayOps(contents);
    var jsx$3 = x2.scala$scalajs$js$ArrayOps$$array$f
  } else if ($is_sjs_js_WrappedArray(contents)) {
    var x3 = $as_sjs_js_WrappedArray(contents);
    var jsx$3 = x3.array$6
  } else {
    var result = [];
    contents.foreach__F1__V(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($this, result$1) {
      return (function(x$2) {
  ...
  var jsx$2 = [elementName, properties].concat(jsx$3);
  return jsx$4.apply(jsx$1, jsx$2)
});
var $d_Lslinky_core_facade_React$ = new $TypeData().initClass({
  Lslinky_core_facade_React$: 0
}, false, "slinky.core.facade.React$", {
  Lslinky_core_facade_React$: 1,
  O: 1
});
$c_Lslinky_core_facade_React$.prototype.$classData = $d_Lslinky_core_facade_React$;
var $n_Lslinky_core_facade_React$ = (void 0);
function $m_Lslinky_core_facade_React$() {
  if ((!$n_Lslinky_core_facade_React$)) {
    $n_Lslinky_core_facade_React$ = new $c_Lslinky_core_facade_React$().init___()
  };
  return $n_Lslinky_core_facade_React$
}
/** @constructor */
...
/** @constructor */
function $c_Lexample_diode_store_CounterStore$CounterHandler() {
  $c_Ldiode_ActionHandler.call(this)
}
$c_Lexample_diode_store_CounterStore$CounterHandler.prototype = new $h_Ldiode_ActionHandler();
$c_Lexample_diode_store_CounterStore$CounterHandler.prototype.constructor = $c_Lexample_diode_store_CounterStore$CounterHandler;
/** @constructor */
function $h_Lexample_diode_store_CounterStore$CounterHandler() {
  /*<skip>*/
}
$h_Lexample_diode_store_CounterStore$CounterHandler.prototype = $c_Lexample_diode_store_CounterStore$CounterHandler.prototype;
$c_Lexample_diode_store_CounterStore$CounterHandler.prototype.init___ = (function() {
  var this$1 = $m_Lexample_diode_store_AppCircuit$();
  var get = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(x$1$2) {
    var x$1 = $as_Lexample_diode_store_AppModel(x$1$2);
...
var $d_Lexample_diode_store_CounterStore$CounterHandler = new $TypeData().initClass({
  Lexample_diode_store_CounterStore$CounterHandler: 0
}, false, "example.diode.store.CounterStore$CounterHandler", {
  Lexample_diode_store_CounterStore$CounterHandler: 1,
  Ldiode_ActionHandler: 1,
  O: 1
});
$c_Lexample_diode_store_CounterStore$CounterHandler.prototype.$classData = $d_Lexample_diode_store_CounterStore$CounterHandler;
/** @constructor */
...
/** @constructor */
function $c_Lslinky_core_ExternalComponentNoPropsWithAttributes() {
  $c_Lslinky_core_ExternalComponentNoPropsWithAttributesWithRefType.call(this)
}
$c_Lslinky_core_ExternalComponentNoPropsWithAttributes.prototype = new $h_Lslinky_core_ExternalComponentNoPropsWithAttributesWithRefType();
$c_Lslinky_core_ExternalComponentNoPropsWithAttributes.prototype.constructor = $c_Lslinky_core_ExternalComponentNoPropsWithAttributes;
/** @constructor */
function $h_Lslinky_core_ExternalComponentNoPropsWithAttributes() {
  /*<skip>*/
}
$h_Lslinky_core_ExternalComponentNoPropsWithAttributes.prototype = $c_Lslinky_core_ExternalComponentNoPropsWithAttributes.prototype;
/** @constructor */
function $c_Lslinky_core_ExternalComponentWithAttributes() {
  $c_Lslinky_core_ExternalComponentWithAttributesWithRefType.call(this)
}
$c_Lslinky_core_ExternalComponentWithAttributes.prototype = new $h_Lslinky_core_ExternalComponentWithAttributesWithRefType();
$c_Lslinky_core_ExternalComponentWithAttributes.prototype.constructor = $c_Lslinky_core_ExternalComponentWithAttributes;
/** @constructor */
function $h_Lslinky_core_ExternalComponentWithAttributes() {
  /*<skip>*/
}
$h_Lslinky_core_ExternalComponentWithAttributes.prototype = $c_Lslinky_core_ExternalComponentWithAttributes.prototype;
/** @constructor */
...
/** @constructor */
function $c_Lslinky_core_facade_ContextProviderProps$$$Lambda$1() {
  $c_O.call(this);
  this.f$1 = null
}
$c_Lslinky_core_facade_ContextProviderProps$$$Lambda$1.prototype = new $h_O();
$c_Lslinky_core_facade_ContextProviderProps$$$Lambda$1.prototype.constructor = $c_Lslinky_core_facade_ContextProviderProps$$$Lambda$1;
/** @constructor */
function $h_Lslinky_core_facade_ContextProviderProps$$$Lambda$1() {
  /*<skip>*/
}
$h_Lslinky_core_facade_ContextProviderProps$$$Lambda$1.prototype = $c_Lslinky_core_facade_ContextProviderProps$$$Lambda$1.prototype;
$c_Lslinky_core_facade_ContextProviderProps$$$Lambda$1.prototype.init___O = (function(f) {
  this.f$1 = f;
  return this
});
$c_Lslinky_core_facade_ContextProviderProps$$$Lambda$1.prototype.write__O__sjs_js_Object = (function(p) {
  return (0, this.f$1)(p)
});
var $d_Lslinky_core_facade_ContextProviderProps$$$Lambda$1 = new $TypeData().initClass({
  Lslinky_core_facade_ContextProviderProps$$$Lambda$1: 0
}, false, "slinky.core.facade.ContextProviderProps$$$Lambda$1", {
  Lslinky_core_facade_ContextProviderProps$$$Lambda$1: 1,
  O: 1,
  Lslinky_readwrite_Writer: 1
});
$c_Lslinky_core_facade_ContextProviderProps$$$Lambda$1.prototype.$classData = $d_Lslinky_core_facade_ContextProviderProps$$$Lambda$1;
...
/** @constructor */
function $c_Lexample_diode_App$() {
  $c_Lslinky_core_StatelessComponentWrapper.call(this);
  this.diodeContext$3 = null
}
$c_Lexample_diode_App$.prototype = new $h_Lslinky_core_StatelessComponentWrapper();
$c_Lexample_diode_App$.prototype.constructor = $c_Lexample_diode_App$;
/** @constructor */
function $h_Lexample_diode_App$() {
  /*<skip>*/
}
$h_Lexample_diode_App$.prototype = $c_Lexample_diode_App$.prototype;
$c_Lexample_diode_App$.prototype.init___ = (function() {
  ...
  $n_Lexample_diode_App$ = this;
  this.diodeContext$3 = $m_Lslinky_core_facade_React$().createContext__O__Lslinky_core_facade_ReactContext($m_Lexample_diode_store_AppCircuit$());
  return this
});
var $d_Lexample_diode_App$ = new $TypeData().initClass({
  Lexample_diode_App$: 0
}, false, "example.diode.App$", {
  Lexample_diode_App$: 1,
  Lslinky_core_StatelessComponentWrapper: 1,
  Lslinky_core_BaseComponentWrapper: 1,
  O: 1
});
$c_Lexample_diode_App$.prototype.$classData = $d_Lexample_diode_App$;
var $n_Lexample_diode_App$ = (void 0);
function $m_Lexample_diode_App$() {
  if ((!$n_Lexample_diode_App$)) {
    $n_Lexample_diode_App$ = new $c_Lexample_diode_App$().init___()
  };
  return $n_Lexample_diode_App$
}
/** @constructor */
function $c_Lexample_diode_store_AppCircuit$() {
  $c_O.call(this);
...
$c_Lexample_diode_store_AppCircuit$.prototype = new $h_O();
$c_Lexample_diode_store_AppCircuit$.prototype.constructor = $c_Lexample_diode_store_AppCircuit$;
/** @constructor */
function $h_Lexample_diode_store_AppCircuit$() {
  /*<skip>*/
}
$h_Lexample_diode_store_AppCircuit$.prototype = $c_Lexample_diode_store_AppCircuit$.prototype;
$c_Lexample_diode_store_AppCircuit$.prototype.init___ = (function() {
  $n_Lexample_diode_store_AppCircuit$ = this;
  $f_Ldiode_Circuit__$$init$__V(this);
  var array = [$m_Ldiode_ActionHandler$().extractHandler__Ldiode_ActionHandler__F2(new $c_Lexample_diode_store_CounterStore$CounterHandler().init___())];
  var handlers = new $c_sjs_js_WrappedArray().init___sjs_js_Array(array);
  this.actionHandler$1 = $f_Ldiode_Circuit__foldHandlers__sc_Seq__F2(this, handlers);
  return this
});
var $d_Lexample_diode_store_AppCircuit$ = new $TypeData().initClass({
  Lexample_diode_store_AppCircuit$: 0
}, false, "example.diode.store.AppCircuit$", {
  Lexample_diode_store_AppCircuit$: 1,
  O: 1,
  Ldiode_Circuit: 1,
  Ldiode_Dispatcher: 1
});
$c_Lexample_diode_store_AppCircuit$.prototype.$classData = $d_Lexample_diode_store_AppCircuit$;
var $n_Lexample_diode_store_AppCircuit$ = (void 0);
function $m_Lexample_diode_store_AppCircuit$() {
  if ((!$n_Lexample_diode_store_AppCircuit$)) {
    $n_Lexample_diode_store_AppCircuit$ = new $c_Lexample_diode_store_AppCircuit$().init___()
  };
  return $n_Lexample_diode_store_AppCircuit$
}
/** @constructor */
function $c_Lslinky_core_ExternalComponent() {
  $c_Lslinky_core_ExternalComponentWithAttributes.call(this)
}
$c_Lslinky_core_ExternalComponent.prototype = new $h_Lslinky_core_ExternalComponentWithAttributes();
$c_Lslinky_core_ExternalComponent.prototype.constructor = $c_Lslinky_core_ExternalComponent;
/** @constructor */
function $h_Lslinky_core_ExternalComponent() {
  /*<skip>*/
}
$h_Lslinky_core_ExternalComponent.prototype = $c_Lslinky_core_ExternalComponent.prototype;
/** @constructor */
function $c_Lslinky_core_ExternalComponentNoProps() {
  $c_Lslinky_core_ExternalComponentNoPropsWithAttributes.call(this)
}
$c_Lslinky_core_ExternalComponentNoProps.prototype = new $h_Lslinky_core_ExternalComponentNoPropsWithAttributes();
$c_Lslinky_core_ExternalComponentNoProps.prototype.constructor = $c_Lslinky_core_ExternalComponentNoProps;
/** @constructor */
function $h_Lslinky_core_ExternalComponentNoProps() {
  /*<skip>*/
}
$h_Lslinky_core_ExternalComponentNoProps.prototype = $c_Lslinky_core_ExternalComponentNoProps.prototype;
/** @constructor */
function $c_Lslinky_core_facade_ContextProviderProps$() {
  $c_O.call(this)
}
$c_Lslinky_core_facade_ContextProviderProps$.prototype = new $h_O();
$c_Lslinky_core_facade_ContextProviderProps$.prototype.constructor = $c_Lslinky_core_facade_ContextProviderProps$;
/** @constructor */
function $h_Lslinky_core_facade_ContextProviderProps$() {
  /*<skip>*/
}
$h_Lslinky_core_facade_ContextProviderProps$.prototype = $c_Lslinky_core_facade_ContextProviderProps$.prototype;
$c_Lslinky_core_facade_ContextProviderProps$.prototype.init___ = (function() {
  return this
});
$c_Lslinky_core_facade_ContextProviderProps$.prototype.writer__Lslinky_readwrite_Writer = (function() {
  return new $c_Lslinky_core_facade_ContextProviderProps$$$Lambda$1().init___O((function($this) {
    return (function(v$2) {
      var v = $as_Lslinky_core_facade_ContextProviderProps(v$2);
      return {
        "value": v.value$1
      }
    })
...
var $d_Lslinky_core_facade_ContextProviderProps$ = new $TypeData().initClass({
  Lslinky_core_facade_ContextProviderProps$: 0
}, false, "slinky.core.facade.ContextProviderProps$", {
  Lslinky_core_facade_ContextProviderProps$: 1,
  O: 1,
  s_Serializable: 1,
  Ljava_io_Serializable: 1
});
$c_Lslinky_core_facade_ContextProviderProps$.prototype.$classData = $d_Lslinky_core_facade_ContextProviderProps$;
var $n_Lslinky_core_facade_ContextProviderProps$ = (void 0);
function $m_Lslinky_core_facade_ContextProviderProps$() {
  if ((!$n_Lslinky_core_facade_ContextProviderProps$)) {
    $n_Lslinky_core_facade_ContextProviderProps$ = new $c_Lslinky_core_facade_ContextProviderProps$().init___()
  };
  return $n_Lslinky_core_facade_ContextProviderProps$
}
...
/** @constructor */
function $c_Lslinky_core_facade_ContextProvider$External$() {
  $c_Lslinky_core_ExternalComponent.call(this);
  this.component$4 = null
}
$c_Lslinky_core_facade_ContextProvider$External$.prototype = new $h_Lslinky_core_ExternalComponent();
$c_Lslinky_core_facade_ContextProvider$External$.prototype.constructor = $c_Lslinky_core_facade_ContextProvider$External$;
/** @constructor */
function $h_Lslinky_core_facade_ContextProvider$External$() {
  /*<skip>*/
}
$h_Lslinky_core_facade_ContextProvider$External$.prototype = $c_Lslinky_core_facade_ContextProvider$External$.prototype;
$c_Lslinky_core_facade_ContextProvider$External$.prototype.init___Lslinky_core_facade_ContextProvider = (function($$outer) {
  var pw = $m_Lslinky_core_facade_ContextProviderProps$().writer__Lslinky_readwrite_Writer();
  $c_Lslinky_core_ExternalComponentWithAttributesWithRefType.prototype.init___Lslinky_core_ExternalPropsWriterProvider.call(this, pw);
  var a = $$outer.slinky$core$facade$ContextProvider$$orig$f.Provider;
  this.component$4 = a;
  return this
});
var $d_Lslinky_core_facade_ContextProvider$External$ = new $TypeData().initClass({
  Lslinky_core_facade_ContextProvider$External$: 0
}, false, "slinky.core.facade.ContextProvider$External$", {
  Lslinky_core_facade_ContextProvider$External$: 1,
  Lslinky_core_ExternalComponent: 1,
  Lslinky_core_ExternalComponentWithAttributes: 1,
  Lslinky_core_ExternalComponentWithAttributesWithRefType: 1,
  O: 1
});
$c_Lslinky_core_facade_ContextProvider$External$.prototype.$classData = $d_Lslinky_core_facade_ContextProvider$External$;
/** @constructor */
function $c_Lslinky_core_facade_Fragment$() {
  $c_Lslinky_core_ExternalComponentNoProps.call(this);
  this.component$4 = null
}
$c_Lslinky_core_facade_Fragment$.prototype = new $h_Lslinky_core_ExternalComponentNoProps();
$c_Lslinky_core_facade_Fragment$.prototype.constructor = $c_Lslinky_core_facade_Fragment$;
/** @constructor */
function $h_Lslinky_core_facade_Fragment$() {
  /*<skip>*/
}
$h_Lslinky_core_facade_Fragment$.prototype = $c_Lslinky_core_facade_Fragment$.prototype;
$c_Lslinky_core_facade_Fragment$.prototype.init___ = (function() {
  $n_Lslinky_core_facade_Fragment$ = this;
  var a = $i_react.Fragment;
  this.component$4 = a;
  return this
});
var $d_Lslinky_core_facade_Fragment$ = new $TypeData().initClass({
  Lslinky_core_facade_Fragment$: 0
}, false, "slinky.core.facade.Fragment$", {
  Lslinky_core_facade_Fragment$: 1,
  Lslinky_core_ExternalComponentNoProps: 1,
  Lslinky_core_ExternalComponentNoPropsWithAttributes: 1,
  Lslinky_core_ExternalComponentNoPropsWithAttributesWithRefType: 1,
  O: 1
});
$c_Lslinky_core_facade_Fragment$.prototype.$classData = $d_Lslinky_core_facade_Fragment$;
var $n_Lslinky_core_facade_Fragment$ = (void 0);
function $m_Lslinky_core_facade_Fragment$() {
  if ((!$n_Lslinky_core_facade_Fragment$)) {
    $n_Lslinky_core_facade_Fragment$ = new $c_Lslinky_core_facade_Fragment$().init___()
  };
  return $n_Lslinky_core_facade_Fragment$
}
/** @constructor */
...
/** @constructor */
function $c_Lexample_diode_store_AppModel() {
  $c_O.call(this);
  this.counter$1 = null
}
$c_Lexample_diode_store_AppModel.prototype = new $h_O();
$c_Lexample_diode_store_AppModel.prototype.constructor = $c_Lexample_diode_store_AppModel;
/** @constructor */
function $h_Lexample_diode_store_AppModel() {
  /*<skip>*/
}
$h_Lexample_diode_store_AppModel.prototype = $c_Lexample_diode_store_AppModel.prototype;
$c_Lexample_diode_store_AppModel.prototype.productPrefix__T = (function() {
  return "AppModel"
});
$c_Lexample_diode_store_AppModel.prototype.productArity__I = (function() {
  return 1
});
$c_Lexample_diode_store_AppModel.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Lexample_diode_store_AppModel(x$1)) {
    var AppModel$1 = $as_Lexample_diode_store_AppModel(x$1);
    var x = this.counter$1;
    var x$2 = AppModel$1.counter$1;
    return ((x === null) ? (x$2 === null) : x.equals__O__Z(x$2))
  } else {
    return false
  }
});
$c_Lexample_diode_store_AppModel.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
...
$c_Lexample_diode_store_AppModel.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Lexample_diode_store_AppModel.prototype.hashCode__I = (function() {
  var this$2 = $m_s_util_hashing_MurmurHash3$();
  return this$2.productHash__s_Product__I__I(this, (-889275714))
});
$c_Lexample_diode_store_AppModel.prototype.init___Lexample_diode_store_CounterStore$CounterState = (function(counter) {
  this.counter$1 = counter;
  return this
});
$c_Lexample_diode_store_AppModel.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
function $is_Lexample_diode_store_AppModel(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lexample_diode_store_AppModel)))
}
function $as_Lexample_diode_store_AppModel(obj) {
  return (($is_Lexample_diode_store_AppModel(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "example.diode.store.AppModel"))
}
function $isArrayOf_Lexample_diode_store_AppModel(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lexample_diode_store_AppModel)))
}
function $asArrayOf_Lexample_diode_store_AppModel(obj, depth) {
  return (($isArrayOf_Lexample_diode_store_AppModel(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lexample.diode.store.AppModel;", depth))
}
var $d_Lexample_diode_store_AppModel = new $TypeData().initClass({
  Lexample_diode_store_AppModel: 0
}, false, "example.diode.store.AppModel", {
  Lexample_diode_store_AppModel: 1,
  O: 1,
  s_Product: 1,
  s_Equals: 1,
  s_Serializable: 1,
...
$c_Lexample_diode_store_AppModel.prototype.$classData = $d_Lexample_diode_store_AppModel;
/** @constructor */
function $c_Lexample_diode_store_CounterStore$CounterState() {
  $c_O.call(this);
  this.count$1 = 0
}
$c_Lexample_diode_store_CounterStore$CounterState.prototype = new $h_O();
$c_Lexample_diode_store_CounterStore$CounterState.prototype.constructor = $c_Lexample_diode_store_CounterStore$CounterState;
/** @constructor */
function $h_Lexample_diode_store_CounterStore$CounterState() {
  /*<skip>*/
}
$h_Lexample_diode_store_CounterStore$CounterState.prototype = $c_Lexample_diode_store_CounterStore$CounterState.prototype;
$c_Lexample_diode_store_CounterStore$CounterState.prototype.productPrefix__T = (function() {
  return "CounterState"
});
$c_Lexample_diode_store_CounterStore$CounterState.prototype.productArity__I = (function() {
  return 1
});
$c_Lexample_diode_store_CounterStore$CounterState.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Lexample_diode_store_CounterStore$CounterState(x$1)) {
    var CounterState$1 = $as_Lexample_diode_store_CounterStore$CounterState(x$1);
    return (this.count$1 === CounterState$1.count$1)
  } else {
    return false
  }
});
$c_Lexample_diode_store_CounterStore$CounterState.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
      return this.count$1;
      break
...
$c_Lexample_diode_store_CounterStore$CounterState.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Lexample_diode_store_CounterStore$CounterState.prototype.init___I = (function(count) {
  this.count$1 = count;
  return this
});
$c_Lexample_diode_store_CounterStore$CounterState.prototype.hashCode__I = (function() {
  var acc = (-889275714);
  acc = $m_sr_Statics$().mix__I__I__I(acc, this.count$1);
  return $m_sr_Statics$().finalizeHash__I__I__I(acc, 1)
});
$c_Lexample_diode_store_CounterStore$CounterState.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
function $is_Lexample_diode_store_CounterStore$CounterState(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lexample_diode_store_CounterStore$CounterState)))
}
function $as_Lexample_diode_store_CounterStore$CounterState(obj) {
  return (($is_Lexample_diode_store_CounterStore$CounterState(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "example.diode.store.CounterStore$CounterState"))
}
function $isArrayOf_Lexample_diode_store_CounterStore$CounterState(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lexample_diode_store_CounterStore$CounterState)))
}
function $asArrayOf_Lexample_diode_store_CounterStore$CounterState(obj, depth) {
  return (($isArrayOf_Lexample_diode_store_CounterStore$CounterState(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lexample.diode.store.CounterStore$CounterState;", depth))
}
var $d_Lexample_diode_store_CounterStore$CounterState = new $TypeData().initClass({
  Lexample_diode_store_CounterStore$CounterState: 0
}, false, "example.diode.store.CounterStore$CounterState", {
  Lexample_diode_store_CounterStore$CounterState: 1,
  O: 1,
  s_Product: 1,
  s_Equals: 1,
  s_Serializable: 1,
...
$c_Lexample_diode_store_CounterStore$CounterState.prototype.$classData = $d_Lexample_diode_store_CounterStore$CounterState;
...
$h_Lslinky_core_facade_ContextProviderProps.prototype = $c_Lslinky_core_facade_ContextProviderProps.prototype;
$c_Lslinky_core_facade_ContextProviderProps.prototype.productPrefix__T = (function() {
  return "ContextProviderProps"
});
$c_Lslinky_core_facade_ContextProviderProps.prototype.productArity__I = (function() {
  return 1
});
$c_Lslinky_core_facade_ContextProviderProps.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Lslinky_core_facade_ContextProviderProps(x$1)) {
    var ContextProviderProps$1 = $as_Lslinky_core_facade_ContextProviderProps(x$1);
    return $m_sr_BoxesRunTime$().equals__O__O__Z(this.value$1, ContextProviderProps$1.value$1)
  } else {
    return false
  }
});
$c_Lslinky_core_facade_ContextProviderProps.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
      return this.value$1;
      break
...
$c_Lslinky_core_facade_ContextProviderProps.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Lslinky_core_facade_ContextProviderProps.prototype.init___O = (function(value) {
  this.value$1 = value;
  return this
});
$c_Lslinky_core_facade_ContextProviderProps.prototype.hashCode__I = (function() {
  var this$2 = $m_s_util_hashing_MurmurHash3$();
  return this$2.productHash__s_Product__I__I(this, (-889275714))
});
$c_Lslinky_core_facade_ContextProviderProps.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
function $is_Lslinky_core_facade_ContextProviderProps(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lslinky_core_facade_ContextProviderProps)))
}
function $as_Lslinky_core_facade_ContextProviderProps(obj) {
  return (($is_Lslinky_core_facade_ContextProviderProps(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "slinky.core.facade.ContextProviderProps"))
}
function $isArrayOf_Lslinky_core_facade_ContextProviderProps(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lslinky_core_facade_ContextProviderProps)))
}
function $asArrayOf_Lslinky_core_facade_ContextProviderProps(obj, depth) {
  return (($isArrayOf_Lslinky_core_facade_ContextProviderProps(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lslinky.core.facade.ContextProviderProps;", depth))
}
var $d_Lslinky_core_facade_ContextProviderProps = new $TypeData().initClass({
  Lslinky_core_facade_ContextProviderProps: 0
}, false, "slinky.core.facade.ContextProviderProps", {
...
$c_Ldiode_ActionResult$NoChange$.prototype.effectOpt__s_Option = (function() {
  return $m_s_None$()
});
...
$c_Ldiode_ActionResult$NoChange$.prototype.newModelOpt__s_Option = (function() {
  return $m_s_None$()
});
...
$c_Ldiode_Circuit$$anonfun$dispatchBase$4.prototype.applyOrElse__jl_Throwable__F1__O = (function(x1, $default) {
  if ((x1 !== null)) {
    ...
    var action = this.action$2$2;
    $f_Ldiode_Circuit__handleEffectProcessingError__O__jl_Throwable__V(this$1, action, x1);
    return (void 0)
  } else {
...
$c_Ldiode_Circuit$$anonfun$dispatchBase$5.prototype.applyOrElse__jl_Throwable__F1__O = (function(x2, $default) {
  if ((x2 !== null)) {
    var this$1 = this.$$outer$2;
    var action = this.action$2$2;
    $f_Ldiode_Circuit__handleEffectProcessingError__O__jl_Throwable__V(this$1, action, x2);
    return (void 0)
  } else {
...
$c_Ldiode_Circuit$$anonfun$dispatchBase$6.prototype.applyOrElse__jl_Throwable__F1__O = (function(x3, $default) {
  if ((x3 !== null)) {
    var this$1 = this.$$outer$2;
    var action = this.action$2$2;
    $f_Ldiode_Circuit__handleEffectProcessingError__O__jl_Throwable__V(this$1, action, x3);
    return (void 0)
  } else {
...
function $s_Lexample_diode_App__$$anonfun$new$1__p5__Lexample_diode_App__V($this) {
  /*<skip>*/
}
function $s_Lexample_diode_App__render__Lexample_diode_App__Lslinky_core_facade_ReactElement($this) {
  var orig = $m_Lexample_diode_App$().diodeContext$3;
  var this$72 = new $c_Lslinky_core_facade_ContextProvider().init___Lslinky_core_facade_ReactContext(orig).apply__O__Lslinky_core_BuildingComponent($m_Lexample_diode_store_AppCircuit$());
  var pair = new $c_Lslinky_core_AttrPair().init___T__sjs_js_Any("className", "App");
  var array = [];
  var dictionary = {};
  dictionary[pair.name$1] = pair.value$1;
  var i = 0;
  ...
  var this$63 = new $c_Lslinky_core_WithAttrs().init___T__sjs_js_Dictionary("div", dictionary);
  var pair$1 = new $c_Lslinky_core_AttrPair().init___T__sjs_js_Any("className", "App-header");
  var array$1 = [];
  var dictionary$1 = {};
  dictionary$1[pair$1.name$1] = pair$1.value$1;
  var i$1 = 0;
  ...
  var this$53 = new $c_Lslinky_core_WithAttrs().init___T__sjs_js_Dictionary("header", dictionary$1);
  var v = $as_T($moduleDefault($i_resources$002flogo$002esvg));
  var pair$2 = new $c_Lslinky_core_AttrPair().init___T__sjs_js_Any("src", v);
  var pair$3 = new $c_Lslinky_core_AttrPair().init___T__sjs_js_Any("className", "App-logo");
  var pair$4 = new $c_Lslinky_core_AttrPair().init___T__sjs_js_Any("alt", "logo");
  var array$2 = [pair$3, pair$4];
  var dictionary$2 = {};
  dictionary$2[pair$2.name$1] = pair$2.value$1;
  var i$2 = 0;
  var len$2 = $uI(array$2.length);
  while ((i$2 < len$2)) {
    ...
    var m$2 = $as_Lslinky_core_AttrPair(arg1$2);
    dictionary$2[m$2.name$1] = m$2.value$1;
    i$2 = ((1 + i$2) | 0)
  };
  var withAttrs = new $c_Lslinky_core_WithAttrs().init___T__sjs_js_Dictionary("img", dictionary$2);
  ...
  var pair$5 = new $c_Lslinky_core_AttrPair().init___T__sjs_js_Any("className", "App-title");
  var array$3 = [];
  var dictionary$3 = {};
  dictionary$3[pair$5.name$1] = pair$5.value$1;
  var i$3 = 0;
  ...
  var this$44 = new $c_Lslinky_core_WithAttrs().init___T__sjs_js_Dictionary("h1", dictionary$3);
  var a$1 = this$44.slinky$core$WithAttrs$$name$f;
  var properties = this$44.slinky$core$WithAttrs$$attrs$f;
  var x1 = $i_react.createElement(a$1, properties, "Welcome to React (with Scala.js!)");
  var a$2 = this$53.slinky$core$WithAttrs$$name$f;
  var properties$1 = this$53.slinky$core$WithAttrs$$attrs$f;
  var x0$1 = $i_react.createElement(a$2, properties$1, x0, x1);
  var this$60 = $m_Lexample_diode_Counter$();
  var x1$1 = this$60.component$1.apply__O__Lslinky_core_facade_ReactElement((void 0));
  var a$3 = this$63.slinky$core$WithAttrs$$name$f;
  var properties$2 = this$63.slinky$core$WithAttrs$$attrs$f;
  var x0$2 = $i_react.createElement(a$3, properties$2, x0$1, x1$1);
  var written = this$72.props$1;
  if ((this$72.key$1 !== null)) {
    var s = this$72.key$1;
    written.key = s
  };
  if ((this$72.ref$1 !== null)) {
    written.ref = this$72.ref$1
  };
  this$72.mods$1.foreach__F1__V(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($this$1, written$1) {
    return (function(m$2$1) {
      var m$4 = $as_Lslinky_core_AttrPair(m$2$1);
      written$1[m$4.name$1] = m$4.value$1
    })
  })(this$72, written)));
  var elementName = this$72.c$1;
  return $i_react.createElement(elementName, written, x0$2)
}
var $b_Lexample_diode_App = (void 0);
function $a_Lexample_diode_App() {
  if ((!$b_Lexample_diode_App)) {
    /** @constructor */
    var $c_Lexample_diode_App = (function $c_Lexample_diode_App(arg$1) {
      var prep0 = arg$1;
      var jsProps = prep0;
      ...
      $m_Lslinky_core_annotations_react$().bump__F0__V(new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function($this) {
        return (function() {
          $s_Lexample_diode_App__$$anonfun$new$1__p5__Lexample_diode_App__V($this)
        })
      })(this)));
      this.css$5 = $moduleDefault($i_resources$002fApp$002ecss)
    });
    /** @constructor */
    var $h_Lexample_diode_App = (function $h_Lexample_diode_App() {
      /*<skip>*/
    });
    $h_Lexample_diode_App.prototype = $a_Lslinky_core_StatelessDefinition().prototype;
    $c_Lexample_diode_App.prototype = new $h_Lexample_diode_App();
    $c_Lexample_diode_App.prototype.constructor = $c_Lexample_diode_App;
    $c_Lexample_diode_App.prototype.render = (function() {
      return $s_Lexample_diode_App__render__Lexample_diode_App__Lslinky_core_facade_ReactElement(this)
    });
    $b_Lexample_diode_App = $c_Lexample_diode_App
  };
  return $b_Lexample_diode_App
}
/** @constructor */
function $c_Lexample_diode_store_CounterStore$CounterHandler$$anonfun$handle$1() {
  $c_sr_AbstractPartialFunction.call(this);
  this.$$outer$2 = null
}
$c_Lexample_diode_store_CounterStore$CounterHandler$$anonfun$handle$1.prototype = new $h_sr_AbstractPartialFunction();
$c_Lexample_diode_store_CounterStore$CounterHandler$$anonfun$handle$1.prototype.constructor = $c_Lexample_diode_store_CounterStore$CounterHandler$$anonfun$handle$1;
/** @constructor */
function $h_Lexample_diode_store_CounterStore$CounterHandler$$anonfun$handle$1() {
  /*<skip>*/
}
$h_Lexample_diode_store_CounterStore$CounterHandler$$anonfun$handle$1.prototype = $c_Lexample_diode_store_CounterStore$CounterHandler$$anonfun$handle$1.prototype;
$c_Lexample_diode_store_CounterStore$CounterHandler$$anonfun$handle$1.prototype.init___Lexample_diode_store_CounterStore$CounterHandler = (function($$outer) {
  if (($$outer === null)) {
    throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(null)
  } else {
    this.$$outer$2 = $$outer
...
$c_Lexample_diode_store_CounterStore$CounterHandler$$anonfun$handle$1.prototype.isDefinedAt__O__Z = (function(x1) {
  var x = $m_Lexample_diode_store_CounterStore$Increment$();
  if ((x === x1)) {
    return true
  } else {
    var x$3 = $m_Lexample_diode_store_CounterStore$Decrement$();
    if ((x$3 === x1)) {
      return true
    } else {
      var x$5 = $m_Lexample_diode_store_CounterStore$Reset$();
      return (x$5 === x1)
    }
  }
});
$c_Lexample_diode_store_CounterStore$CounterHandler$$anonfun$handle$1.prototype.applyOrElse__O__F1__O = (function(x1, $default) {
  var x = $m_Lexample_diode_store_CounterStore$Increment$();
  if ((x === x1)) {
    var jsx$1 = this.$$outer$2;
    var this$1 = this.$$outer$2;
    $as_Lexample_diode_store_CounterStore$CounterState(this$1.modelRW$1.eval__O__O(this$1.currentModel$1));
    var this$2 = this.$$outer$2;
    var count = ((1 + $as_Lexample_diode_store_CounterStore$CounterState(this$2.modelRW$1.eval__O__O(this$2.currentModel$1)).count$1) | 0);
    return jsx$1.updated__O__Ldiode_ActionResult(new $c_Lexample_diode_store_CounterStore$CounterState().init___I(count))
  } else {
    var x$3 = $m_Lexample_diode_store_CounterStore$Decrement$();
    if ((x$3 === x1)) {
      var jsx$2 = this.$$outer$2;
      var this$4 = this.$$outer$2;
      $as_Lexample_diode_store_CounterStore$CounterState(this$4.modelRW$1.eval__O__O(this$4.currentModel$1));
      var this$5 = this.$$outer$2;
      var count$1 = (((-1) + $as_Lexample_diode_store_CounterStore$CounterState(this$5.modelRW$1.eval__O__O(this$5.currentModel$1)).count$1) | 0);
      return jsx$2.updated__O__Ldiode_ActionResult(new $c_Lexample_diode_store_CounterStore$CounterState().init___I(count$1))
    } else {
      var x$5 = $m_Lexample_diode_store_CounterStore$Reset$();
      if ((x$5 === x1)) {
        return this.$$outer$2.updated__O__Ldiode_ActionResult(new $c_Lexample_diode_store_CounterStore$CounterState().init___I(0))
      } else {
        return $default.apply__O__O(x1)
      }
    }
...
var $d_Lexample_diode_store_CounterStore$CounterHandler$$anonfun$handle$1 = new $TypeData().initClass({
  Lexample_diode_store_CounterStore$CounterHandler$$anonfun$handle$1: 0
}, false, "example.diode.store.CounterStore$CounterHandler$$anonfun$handle$1", {
  Lexample_diode_store_CounterStore$CounterHandler$$anonfun$handle$1: 1,
  sr_AbstractPartialFunction: 1,
  O: 1,
  F1: 1,
  s_PartialFunction: 1,
...
$c_Lexample_diode_store_CounterStore$CounterHandler$$anonfun$handle$1.prototype.$classData = $d_Lexample_diode_store_CounterStore$CounterHandler$$anonfun$handle$1;
/** @constructor */
function $c_Lexample_diode_store_CounterStore$Decrement$() {
  $c_O.call(this)
}
$c_Lexample_diode_store_CounterStore$Decrement$.prototype = new $h_O();
$c_Lexample_diode_store_CounterStore$Decrement$.prototype.constructor = $c_Lexample_diode_store_CounterStore$Decrement$;
/** @constructor */
function $h_Lexample_diode_store_CounterStore$Decrement$() {
  /*<skip>*/
}
$h_Lexample_diode_store_CounterStore$Decrement$.prototype = $c_Lexample_diode_store_CounterStore$Decrement$.prototype;
$c_Lexample_diode_store_CounterStore$Decrement$.prototype.init___ = (function() {
  return this
});
$c_Lexample_diode_store_CounterStore$Decrement$.prototype.productPrefix__T = (function() {
  return "Decrement"
});
$c_Lexample_diode_store_CounterStore$Decrement$.prototype.productArity__I = (function() {
  return 0
});
$c_Lexample_diode_store_CounterStore$Decrement$.prototype.productElement__I__O = (function(x$1) {
  throw new $c_jl_IndexOutOfBoundsException().init___T(("" + x$1))
});
$c_Lexample_diode_store_CounterStore$Decrement$.prototype.toString__T = (function() {
  return "Decrement"
});
$c_Lexample_diode_store_CounterStore$Decrement$.prototype.hashCode__I = (function() {
  return (-1688736653)
});
$c_Lexample_diode_store_CounterStore$Decrement$.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
var $d_Lexample_diode_store_CounterStore$Decrement$ = new $TypeData().initClass({
  Lexample_diode_store_CounterStore$Decrement$: 0
}, false, "example.diode.store.CounterStore$Decrement$", {
  Lexample_diode_store_CounterStore$Decrement$: 1,
  O: 1,
  Ldiode_Action: 1,
  s_Product: 1,
  s_Equals: 1,
...
$c_Lexample_diode_store_CounterStore$Decrement$.prototype.$classData = $d_Lexample_diode_store_CounterStore$Decrement$;
var $n_Lexample_diode_store_CounterStore$Decrement$ = (void 0);
function $m_Lexample_diode_store_CounterStore$Decrement$() {
  if ((!$n_Lexample_diode_store_CounterStore$Decrement$)) {
    $n_Lexample_diode_store_CounterStore$Decrement$ = new $c_Lexample_diode_store_CounterStore$Decrement$().init___()
  };
  return $n_Lexample_diode_store_CounterStore$Decrement$
}
/** @constructor */
function $c_Lexample_diode_store_CounterStore$Increment$() {
  $c_O.call(this)
}
$c_Lexample_diode_store_CounterStore$Increment$.prototype = new $h_O();
$c_Lexample_diode_store_CounterStore$Increment$.prototype.constructor = $c_Lexample_diode_store_CounterStore$Increment$;
/** @constructor */
function $h_Lexample_diode_store_CounterStore$Increment$() {
  /*<skip>*/
}
$h_Lexample_diode_store_CounterStore$Increment$.prototype = $c_Lexample_diode_store_CounterStore$Increment$.prototype;
$c_Lexample_diode_store_CounterStore$Increment$.prototype.init___ = (function() {
  return this
});
$c_Lexample_diode_store_CounterStore$Increment$.prototype.productPrefix__T = (function() {
  return "Increment"
});
$c_Lexample_diode_store_CounterStore$Increment$.prototype.productArity__I = (function() {
  return 0
});
$c_Lexample_diode_store_CounterStore$Increment$.prototype.productElement__I__O = (function(x$1) {
  throw new $c_jl_IndexOutOfBoundsException().init___T(("" + x$1))
});
$c_Lexample_diode_store_CounterStore$Increment$.prototype.toString__T = (function() {
  return "Increment"
});
$c_Lexample_diode_store_CounterStore$Increment$.prototype.hashCode__I = (function() {
  return 664316751
});
$c_Lexample_diode_store_CounterStore$Increment$.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
var $d_Lexample_diode_store_CounterStore$Increment$ = new $TypeData().initClass({
  Lexample_diode_store_CounterStore$Increment$: 0
}, false, "example.diode.store.CounterStore$Increment$", {
  Lexample_diode_store_CounterStore$Increment$: 1,
  O: 1,
  Ldiode_Action: 1,
  s_Product: 1,
  s_Equals: 1,
...
$c_Lexample_diode_store_CounterStore$Increment$.prototype.$classData = $d_Lexample_diode_store_CounterStore$Increment$;
var $n_Lexample_diode_store_CounterStore$Increment$ = (void 0);
function $m_Lexample_diode_store_CounterStore$Increment$() {
  if ((!$n_Lexample_diode_store_CounterStore$Increment$)) {
    $n_Lexample_diode_store_CounterStore$Increment$ = new $c_Lexample_diode_store_CounterStore$Increment$().init___()
  };
  return $n_Lexample_diode_store_CounterStore$Increment$
}
/** @constructor */
function $c_Lexample_diode_store_CounterStore$Reset$() {
  $c_O.call(this)
}
$c_Lexample_diode_store_CounterStore$Reset$.prototype = new $h_O();
$c_Lexample_diode_store_CounterStore$Reset$.prototype.constructor = $c_Lexample_diode_store_CounterStore$Reset$;
/** @constructor */
function $h_Lexample_diode_store_CounterStore$Reset$() {
  /*<skip>*/
}
$h_Lexample_diode_store_CounterStore$Reset$.prototype = $c_Lexample_diode_store_CounterStore$Reset$.prototype;
$c_Lexample_diode_store_CounterStore$Reset$.prototype.init___ = (function() {
  return this
});
$c_Lexample_diode_store_CounterStore$Reset$.prototype.productPrefix__T = (function() {
  return "Reset"
});
$c_Lexample_diode_store_CounterStore$Reset$.prototype.productArity__I = (function() {
  return 0
});
$c_Lexample_diode_store_CounterStore$Reset$.prototype.productElement__I__O = (function(x$1) {
  throw new $c_jl_IndexOutOfBoundsException().init___T(("" + x$1))
});
$c_Lexample_diode_store_CounterStore$Reset$.prototype.toString__T = (function() {
  return "Reset"
});
$c_Lexample_diode_store_CounterStore$Reset$.prototype.hashCode__I = (function() {
  return 78851375
});
$c_Lexample_diode_store_CounterStore$Reset$.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
var $d_Lexample_diode_store_CounterStore$Reset$ = new $TypeData().initClass({
  Lexample_diode_store_CounterStore$Reset$: 0
}, false, "example.diode.store.CounterStore$Reset$", {
  Lexample_diode_store_CounterStore$Reset$: 1,
  O: 1,
  Ldiode_Action: 1,
  s_Product: 1,
  s_Equals: 1,
...
$c_Lexample_diode_store_CounterStore$Reset$.prototype.$classData = $d_Lexample_diode_store_CounterStore$Reset$;
var $n_Lexample_diode_store_CounterStore$Reset$ = (void 0);
function $m_Lexample_diode_store_CounterStore$Reset$() {
  if ((!$n_Lexample_diode_store_CounterStore$Reset$)) {
    $n_Lexample_diode_store_CounterStore$Reset$ = new $c_Lexample_diode_store_CounterStore$Reset$().init___()
  };
  return $n_Lexample_diode_store_CounterStore$Reset$
}
/** @constructor */
function $c_T2() {
  $c_O.call(this);
...
/** @constructor */
function $c_Ldiode_ActionResult$EffectOnly() {
  $c_O.call(this);
  this.effect$1 = null
}
$c_Ldiode_ActionResult$EffectOnly.prototype = new $h_O();
$c_Ldiode_ActionResult$EffectOnly.prototype.constructor = $c_Ldiode_ActionResult$EffectOnly;
/** @constructor */
function $h_Ldiode_ActionResult$EffectOnly() {
  /*<skip>*/
}
$h_Ldiode_ActionResult$EffectOnly.prototype = $c_Ldiode_ActionResult$EffectOnly.prototype;
$c_Ldiode_ActionResult$EffectOnly.prototype.productPrefix__T = (function() {
  return "EffectOnly"
});
$c_Ldiode_ActionResult$EffectOnly.prototype.productArity__I = (function() {
  return 1
});
$c_Ldiode_ActionResult$EffectOnly.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Ldiode_ActionResult$EffectOnly(x$1)) {
    var EffectOnly$1 = $as_Ldiode_ActionResult$EffectOnly(x$1);
    var x = this.effect$1;
    var x$2 = EffectOnly$1.effect$1;
    return ((x === null) ? (x$2 === null) : x.equals__O__Z(x$2))
  } else {
    return false
  }
});
$c_Ldiode_ActionResult$EffectOnly.prototype.effectOpt__s_Option = (function() {
  return new $c_s_Some().init___O(this.effect$1)
});
$c_Ldiode_ActionResult$EffectOnly.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
...
$c_Ldiode_ActionResult$EffectOnly.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Ldiode_ActionResult$EffectOnly.prototype.init___Ldiode_Effect = (function(effect) {
  this.effect$1 = effect;
  return this
});
$c_Ldiode_ActionResult$EffectOnly.prototype.newModelOpt__s_Option = (function() {
  return $m_s_None$()
});
$c_Ldiode_ActionResult$EffectOnly.prototype.hashCode__I = (function() {
  var this$2 = $m_s_util_hashing_MurmurHash3$();
  return this$2.productHash__s_Product__I__I(this, (-889275714))
});
$c_Ldiode_ActionResult$EffectOnly.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
...
var $d_Ldiode_ActionResult$EffectOnly = new $TypeData().initClass({
  Ldiode_ActionResult$EffectOnly: 0
}, false, "diode.ActionResult$EffectOnly", {
  Ldiode_ActionResult$EffectOnly: 1,
  O: 1,
  Ldiode_ActionResult: 1,
  Ldiode_HasEffect: 1,
  s_Product: 1,
...
$c_Ldiode_ActionResult$EffectOnly.prototype.$classData = $d_Ldiode_ActionResult$EffectOnly;
/** @constructor */
...
$c_Ldiode_ActionResult$ModelUpdate.prototype.effectOpt__s_Option = (function() {
  return $m_s_None$()
});
...
$c_Ldiode_ActionResult$ModelUpdate.prototype.newModelOpt__s_Option = (function() {
  return new $c_s_Some().init___O(this.newModel$1)
});
...
$c_Ldiode_ActionResult$ModelUpdateEffect.prototype.effectOpt__s_Option = (function() {
  return new $c_s_Some().init___O(this.effect$1)
});
...
$c_Ldiode_ActionResult$ModelUpdateEffect.prototype.newModelOpt__s_Option = (function() {
  return new $c_s_Some().init___O(this.newModel$1)
});
